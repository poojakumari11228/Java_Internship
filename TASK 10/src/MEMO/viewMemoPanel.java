 ...
 * @author POOJA
 */
public class viewMemoPanel extends javax.swing.JPanel {
...
//   System.out.println(titleField.getText()+"\n"+date+"\n"+memoText.getText()+"\n"+todoTime.getFormatedTime()+"\n"+jPanel1.getName());
    ...
    private void initComponents() {
        ...
        dltBtn.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(headPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 220, Short.MAX_VALUE)
                .addGap(126, 126, 126))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(9, 9, 9)
...
System.out.println("==================deleting---------------"+jPanel1.getName());
v.searchField.setText("SEARCH THROUGH TITLE OR DESCCRIPTION");
v.backPanel.removeAll();
v.validate();
v.repaint();
v.fetchAll(query);
